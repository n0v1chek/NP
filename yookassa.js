...
/**
 * Предопределённые суммы пополнения (кратные 75)
 */
const TOPUP_AMOUNTS = [
  { amount: 150, label: '150 ₽ (2 генерации)' },
  { amount: 375, label: '375 ₽ (5 генераций)' },
  { amount: 750, label: '750 ₽ (10 генераций)' },
  { amount: 1500, label: '1500 ₽ (20 генераций)' },
  { amount: 3750, label: '3750 ₽ (50 генераций)' },
  { amount: 7500, label: '7500 ₽ (100 генераций)' }
];
